...
export function TaskDrawer({ task, projectKey, labels = [], taskLabels = [], links = [], activities = [], onClose, onSave, onArchive, onSetLabels, onAddLink, onRemoveLink, onOpenDocument }) {
