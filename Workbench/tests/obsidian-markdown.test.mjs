...
test("explicit attachment paths preserve extensions before Markdown fallback", () => {
  assert.equal(vaultPathCandidates("wiki/procedures/Recovery.md", "../../.raw/oracle/check.sql")[0], ".raw/oracle/check.sql");
  assert.equal(vaultPathCandidates("wiki/procedures/Recovery.md", ".raw/manual.pdf")[0], ".raw/manual.pdf");
});
